...
# the installation and usage of deshifter with docker-sync.
...
display_options () {
    ...
    print_style "   bash" "success"; printf "\t\t\t Opens bash on the workspace with user deshifter.\n"
...
if [ "$1" == "up" ] ; then
    ...
    docker-compose exec --user=deshifter workspace bash
