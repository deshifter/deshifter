...
# the installation and usage of expocker with docker-sync.
...
display_options () {
    ...
    print_style "   bash" "success"; printf "\t\t\t Opens bash on the workspace with user expocker.\n"
...
if [ "$1" == "up" ] ; then
    ...
    docker-compose exec --user=expocker workspace bash
