...
# the installation and usage of exployer with docker-sync.
...
display_options () {
    ...
    print_style "   bash" "success"; printf "\t\t\t Opens bash on the workspace with user exployer.\n"
...
if [ "$1" == "up" ] ; then
    ...
    docker-compose exec --user=exployer workspace bash
